...
const (
	 ...
	 */
	AV_SPHERICAL_EQUIRECTANGULAR = iota
...
func AvSphericalAlloc(size *ffcommon.FSizeT) (res *AVSphericalMapping) {
...
func AvSphericalFromName(name ffcommon.FConstCharP) (res ffcommon.FInt) {

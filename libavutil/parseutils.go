...
func (q *AVRational) AvParseRatio(str ffcommon.FConstCharP, max,
...
func AvParseVideoSize(width_ptr, height_ptr *ffcommon.FInt, str ffcommon.FConstCharP) (res ffcommon.FInt) {
...
//void *log_ctx);
func AvParseColor(rgba_color *ffcommon.FUint8T, color_string ffcommon.FConstCharP, slen ffcommon.FInt, log_ctx ffcommon.FVoidP) (res ffcommon.FInt) {
	t, _, _ := ffcommon.GetAvutilDll().NewProc("av_parse_color").Call(
		uintptr(unsafe.Pointer(rgba_color)),
		ffcommon.UintPtrFromString(color_string),
		uintptr(slen),
		log_ctx,
	)
	res = ffcommon.FInt(t)
...
func AvGetKnownColorName(color_idx ffcommon.FInt, rgb **ffcommon.FUint8T) (res ffcommon.FConstCharP) {
...
func AvFindInfoTag(arg ffcommon.FConstCharP, arg_size ffcommon.FInt, tag1, info ffcommon.FConstCharP) (res ffcommon.FInt) {

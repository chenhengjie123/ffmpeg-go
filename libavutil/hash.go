...
func AvHashAlloc(ctx **AVHashContext, name ffcommon.FConstCharP) (res ffcommon.FInt) {
...
func AvHashNames(i ffcommon.FInt) (res ffcommon.FCharP) {
...
func (ctx *AVHashContext) AvHashGetName() (res ffcommon.FCharP) {
...
func (ctx *AVHashContext) AvHashGetSize() (res ffcommon.FInt) {

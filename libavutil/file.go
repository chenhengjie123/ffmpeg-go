...
func AvTempfile(prefix ffcommon.FConstCharP, filename *ffcommon.FBuf, log_offset ffcommon.FInt, log_ctx ffcommon.FVoidP) (res ffcommon.FInt) {
	t, _, _ := ffcommon.GetAvutilDll().NewProc("av_tempfile").Call(
		ffcommon.UintPtrFromString(prefix),

...
func AvGetChannelLayout(name ffcommon.FConstCharP) (res ffcommon.FUint64T) {
...
func AvGetExtendedChannelLayout(name ffcommon.FConstCharP, channel_layout *ffcommon.FUint64T, nb_channels *ffcommon.FUint) (res ffcommon.FInt) {
...
func AvGetChannelLayoutNbChannels(channel_layout ffcommon.FUint64T) (res ffcommon.FInt) {
...
func AvGetDefaultChannelLayout(nb_channels ffcommon.FInt) (res ffcommon.FInt64T) {
...
//uint64_t channel);
func AvGetChannelLayoutChannelIndex(channel_layout, channel ffcommon.FUint64T) (res ffcommon.FInt) {
...
func AvChannelLayoutExtractChannel(channel_layout ffcommon.FUint64T, index ffcommon.FInt) (res ffcommon.FUint64T) {
...
func AvGetChannelName(channel ffcommon.FUint64T) (res ffcommon.FConstCharP) {
...
func AvGetChannelDescription(channel ffcommon.FUint64T) (res ffcommon.FConstCharP) {
...
//const char **name);
func AvGetStandardChannelLayout(index ffcommon.FUnsigned, layout *ffcommon.FUint64T, name *ffcommon.FBuf) (res ffcommon.FInt) {

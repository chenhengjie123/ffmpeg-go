...
func AvImageGetLinesize(pix_fmt AVPixelFormat, width, plane ffcommon.FInt) (res ffcommon.FInt) {
...
func AvImageGetBufferSize(pix_fmt AVPixelFormat, width, height, align ffcommon.FInt) (res ffcommon.FInt) {
...
func AvImageCheckSize(w, h ffcommon.FUnsignedInt, log_offset ffcommon.FInt, log_ctx ffcommon.FVoidP) (res ffcommon.FInt) {
...
func AvImageCheckSize2(w, h ffcommon.FUnsignedInt, max_pixels ffcommon.FInt64T, pix_fmt AVPixelFormat, log_offset ffcommon.FInt, log_ctx ffcommon.FVoidP) (res ffcommon.FInt) {
...
func AvImageCheckSar(w, h ffcommon.FUnsignedInt, sar AVRational) (res ffcommon.FInt) {
...
func AvImageFillBlack(dst_data [4]*ffcommon.FUint8T, dst_linesize [4]ffcommon.FPtrdiffT,
	pix_fmt AVPixelFormat, range0 AVColorRange,
	width, height ffcommon.FInt) (res ffcommon.FInt) {

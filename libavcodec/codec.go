...
type AVCodec struct {
	...
	SupportedFramerates  *AVRational        ///< array of supported framerates, or NULL if any, array is terminated by {0,0}
	PixFmts              *AVPixelFormat     ///< array of supported pixel formats, or NULL if unknown, array is terminated by -1
	SupportedSamplerates *ffcommon.FInt     ///< array of supported audio samplerates, or NULL if unknown, array is terminated by 0
	SampleFmts           *AVSampleFormat    ///< array of supported sample formats, or NULL if unknown, array is terminated by -1
	ChannelLayouts       *ffcommon.FUint64T ///< array of support channel layouts, or NULL if unknown. array is terminated by 0
	MaxLowres            ffcommon.FUint8T   ///< maximum value for lowres supported by the decoder
	RivClass             *AVClass           ///< AVClass for the private context
	 ...
	 */
	WrapperName ffcommon.FCharPStruct
	...
	HwConfigs uintptr // *AVCodecHWConfigInternal
